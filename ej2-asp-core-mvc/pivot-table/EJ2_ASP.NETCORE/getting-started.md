...
To integrate the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Pivot Table component, install the required [Syncfusion.EJ2.AspNet.Core](https://www.nuget.org/packages/Syncfusion.EJ2.AspNet.Core/) NuGet packages using the integrated terminal:
...
Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Pivot Table tag helper in `~/Pages/Index.cshtml` page.
